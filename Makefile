...
all: compress uncompress testbuild testbits


testbits: BitInputStream.o BitOutputStream.o HCNode.o HCTree.o 
testbuild: BitInputStream.o BitOutputStream.o HCNode.o HCTree.o 
